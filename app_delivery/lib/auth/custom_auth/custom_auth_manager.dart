...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    appDeliveryAuthUserSubject.add(
      AppDeliveryAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<AppDeliveryAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  AppDeliveryAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = AppDeliveryAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    appDeliveryAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
AppDeliveryAuthUser? currentUser;
