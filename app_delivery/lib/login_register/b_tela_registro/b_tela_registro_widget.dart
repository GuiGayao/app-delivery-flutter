...
import 'b_tela_registro_model.dart';
export 'b_tela_registro_model.dart';

class BTelaRegistroWidget extends StatefulWidget {
  const BTelaRegistroWidget({super.key});

  static String routeName = 'B_Tela_Registro';
  static String routePath = '/bTelaRegistro';

  @override
  State<BTelaRegistroWidget> createState() => _BTelaRegistroWidgetState();
}

class _BTelaRegistroWidgetState extends State<BTelaRegistroWidget> {
  late BTelaRegistroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BTelaRegistroModel());
                                        ...
                                        onPressed: () async {
                                          if (functions.tamanhoValido(
                                            ...
                                            if (functions.textosIguais(
                                              ...
                                              if (functions.tamanhoValido(
                                                ...
                                                if (functions.tamanhoValido(
                                                    ...
                                                    5,
                                                    50)) {
                                                  _model.apiCadastroUsuarioXano =
                                                      await ApiXanoCadastroUsuarioCall
                                                          .call(
                                                    usuarioNome: _model
                                                        .nomeTextController
                                                        .text,
                                            ...
                                            ScaffoldMessenger.of(context)
                                              ...
                                              SnackBar(
                                                content: Text(
                                                  'Senha com tamanho inválido\" (Deve conter de 6 a 32 caracteres.)',
                                                  style: TextStyle(
                                                    color: FlutterFlowTheme.of(
                                                            context)
                                                        .secondaryBackground,
