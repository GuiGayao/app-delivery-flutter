...
import 'd_tela_login_model.dart';
export 'd_tela_login_model.dart';

class DTelaLoginWidget extends StatefulWidget {
  const DTelaLoginWidget({
    super.key,
    this.email,
    this.senha,
  });
  ...
  static String routeName = 'D_Tela_Login';
  static String routePath = '/dTelaLogin';

  @override
  State<DTelaLoginWidget> createState() => _DTelaLoginWidgetState();
}

class _DTelaLoginWidgetState extends State<DTelaLoginWidget> {
  late DTelaLoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DTelaLoginModel());
