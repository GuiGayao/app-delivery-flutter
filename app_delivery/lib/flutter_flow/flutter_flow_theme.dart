...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFC2A68C);
  late Color secondary = const Color(0xFFF0F0F0);
  late Color tertiary = const Color(0xFFE0E0E0);
  ...
  late Color accent1 = const Color(0xFFD6BCA2);
  ...
  late Color customColor1 = const Color(0xFFBF0260);
  late Color customColor2 = const Color(0xFF7B5406);
  late Color customColor3 = const Color(0xFF61982B);
}
...
class ThemeTypography extends Typography {
  ...
  TextStyle get titleMedium => GoogleFonts.playfairDisplay(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 18.0,
      );
  ...
  TextStyle get titleSmall => GoogleFonts.playfairDisplay(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 16.0,
      );
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color accent2 = const Color(0xFFBB86FC);
